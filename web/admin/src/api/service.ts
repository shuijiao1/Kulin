import { ModelService, ModelServiceForm } from "@/types"
...
export const getServices = async (): Promise<ModelService[]> => {
    return fetcher<ModelService[]>(FetcherMethod.GET, "/api/v1/service/list", null)
}
